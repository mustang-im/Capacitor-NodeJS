...
const destinations = ['android/src/main/assets/builtin_modules/bridge', 'electron/assets/builtin_modules/bridge', 'ios/Plugin/builtin_modules/bridge'];
...
export default [
  {
    ...
    plugins: [copy({ targets: generateCopyTargets() })],
  },
  {
